# python code/preprocess/split_dataset.py ./data/1_Quantized/Table/ --r_val 0.05 --r_test 0.05
import argparse
import os
import random
import glob
...
# all_samples = [os.path.basename(name) for name in glob.glob(os.path.join(args.in_folder, '*npy')) 
